      ...
      <div className="container infos">
        <div className="notification is-warning has-text-left info-box notification-topped">
          ...
          <p className="">
            ...
            your Sauco or you top it up and gift it to a friend.<br />
            Now you can access this wallet with Sauco Nano by entering the 12
            words passphrase. The balance of this wallet is ________________
            Sauco. You will need to send some Sauco to the address{" "}
            ...
            has this passphrase can access the Sauco contained in this wallet.
            ...
            your first outgoing transaction of 0.001 SAUCO and address it to
            yourself.
            <br />
            <br />
          </p>
